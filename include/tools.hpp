...
namespace tools
{
    inline double zenith(const double heightAboveSeaLevel, const double distance) {
    ...
    inline double beamWideningVacuum(const double distance, const double apertureDiameter,
    ...
    inline double beamWideningAtmosphere(const double distance, const double apertureDiameter,
    ...
    inline double turbulenceStrength(const double heightAboveSeaLevel, const double windSpeed) {
    ...
    inline double targetingError(const double distance, const double targetingAngularError) {
    ...
    inline double totalScattering(const double beamRadius, const double targetingError) {
    ...
    inline double dynamicTransmittance(const double totalScattering, const double mirrorRadius) {
    ...
    inline double staticTransmittance(const std::vector<double> &molecularScattering,
    ...
    inline double beamWideningEarthSpace(const double waveLength, const std::vector<double> &sectors,
    ...
    inline double beamWideningSpaceEarth(const double waveLength, const std::vector<double> &sectors,
                                         const double distance, const double windSpeed, const double zenith){
